...
WITH cofobyyear AS (
    SELECT
        ...
        max(CASE WHEN cofo_year = '2010-PreCensus' THEN numofdwellingunits::numeric END) as u_2010pre_existtotal,
        max(CASE WHEN cofo_year = '2010-PostCensus' THEN numofdwellingunits::numeric END) as u_2010post_existtotal,
        ...
        max(CASE WHEN cofo_year = '18' THEN numofdwellingunits::numeric END) as u_2018_existtotal,
...
SET u_2007_existtotal = b.u_2007_existtotal,
    ...
    u_2018_existtotal = b.u_2018_existtotal,

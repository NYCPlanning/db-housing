...
db.any(nullGeomQuery)
  .then(function (data) { 
    ...
    console.log('Found ' + nullGeomResults.length + ' null geometries in housing ')
...
function updateFacilities(data, row) {
  ...
  var insertTemplate = `UPDATE housing 
                        SET
                          geom=(CASE
                          ...
                          longitude=(CASE
                            ...
                            ELSE longitude
                          END),
                          address_house=\'{{newaddressnum}}\',
                          address_street=initcap(\'{{newstreetname}}\'),
                          address=initcap(CONCAT(\'{{newaddressnum}}\',\' \',\'{{newstreetname}}\')),
                          bbl=\'{{bbl}}\',
                          bin=\'{{bin}}\'
                        WHERE
                          address_house=\'{{oldaddressnum}}\'
                          AND address_street=\'{{oldstreetname}}\'
                          AND upper(boro) = \'{{boro}}\'`;

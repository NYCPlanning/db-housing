...
housing = pd.read_sql_query('SELECT DISTINCT address_house, address_street, boro FROM housing WHERE address_house IS NOT NULL AND address_street IS NOT NULL AND address IS NOT NULL AND boro IS NOT NULL AND geom IS NULL LIMIT 1000;', engine)
